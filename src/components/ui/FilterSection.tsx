...
import {DateOption, dateOptions, setDateOption, setEvents} from "../../redux/slices/FilterSlice";
...
export default function FilterSection(props: FilterSectionProps) {
    ...
    const datePickerDate = useSelector((state: AppState) => state.filter.startDate);
    const eventFilter = useSelector((state: AppState) => state.filter.eventsFilter);
    const fromDateOption = useSelector((state: AppState) => state.filter.dateOption);
